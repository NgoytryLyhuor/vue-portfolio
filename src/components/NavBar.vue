            ...
            <div class="flex items-center space-x-6">
                ...
                <div class="hidden md:flex space-x-6">
                    <router-link v-for="link in navLinks" :key="link.path" :to="link.path"
                        class="hover:text-green-500 dark:hover:text-green-400 transition-colors duration-200 px-2 py-1 rounded-md"
                ...
                <div class="relative" ref="themeDropdown">
                    <button @click="toggleThemeMenu"
                        ...
                        <svg v-else-if="currentTheme === 'system'" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5"
                            viewBox="0 0 20 20" fill="currentColor">
                            <path fill-rule="evenodd"
